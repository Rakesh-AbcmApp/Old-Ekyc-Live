...
public class ResponseDispatcher {
    ...
    public <T> T getPanResponse(String providerName, JSONObject input, String trackId, String merchanId, Long productRate,String orderId) {
        ...
        return handler.PanVerifyResponseToMerchant(input, trackId, merchanId, productRate,orderId);
    }
}
