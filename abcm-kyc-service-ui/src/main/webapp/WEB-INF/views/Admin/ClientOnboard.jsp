            ...
            <div class="row">
                <div class="col-md-4 col-12">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Provider Name" name="providerName" aria-label="Username" aria-describedby="basic-addon1" />
                    </div>
                </div>
                <div class="col-md-4 col-12">
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1"><i class="fas fa-link"></i></span>
                        <input type="text" class="form-control" placeholder="Provider Aaddhar URL1" name="aaddharUrl1" aria-label="Email" aria-describedby="basic-addon1" />
                    </div>
                </div>
                <div class="col-md-4 col-12">
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1"><i class="fas fa-link"></i></span>
                        <input type="text" class="form-control" placeholder=" Provider Aaddhar URL2" name="aaddharUrl2" aria-label="Phone" aria-describedby="basic-addon1" />
                    </div>
                </div>
                ...
                <div class="col-md-4 col-12">
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1"><i class="fas fa-link"></i></span>
                        <input type="text" class="form-control" placeholder=" Provider Gst Url1" aria-label="Phone" name="gstUrl1" aria-describedby="basic-addon1" />
                    </div>
                </div>
               ...
               <!--  <div class="col-md-4 col-12">
                ...
                <div class="col-md-4 col-12">
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1"><i class="fas fa-link"></i></span>
                        <input type="text" class="form-control" placeholder=" Provider Pan Url1" aria-label="Phone" name="panUrl1" aria-describedby="basic-addon1" />
                    </div>
                </div>
                 ...
                 <div class="col-md-4 col-12">
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1"><i class="fas fa-link"></i></span>
                        <input type="text" class="form-control" placeholder=" Provider Pan Url1" aria-label="Phone" name="drivingLicense" aria-describedby="basic-addon1" />
                    </div>
                </div>
                ...
                <div class="col-md-4 col-12">
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1"><i class="fas fa-link"></i></span>
                        <input type="text" class="form-control" placeholder=" Provider Pan Url1" aria-label="Phone" name="voterId" aria-describedby="basic-addon1" />
                    </div>
                </div>
               ...
               <!--  <div class="col-md-4 col-12">
                ...
                <div class="col-md-4 col-12">
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1"><i class="fas fa-link"></i></span>
                        <input type="text" class="form-control" placeholder="Api Key" name="apiKey" aria-label="username" aria-describedby="basic-addon1" />
                    </div>
                </div>
                <div class="col-md-4 col-12">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="App Id" aria-label="Email" name="apiId" aria-describedby="basic-addon1" />
                    </div>
                </div>

                <div class="col-md-4 col-12">
                    <label for="merchantPhoneNo" class="form-label"> Environment</label>
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1"><i class="far fa-hand-pointer"></i></span>
                        <select class="form-select" id="inputGroupSelect03" aria-label="Example select with button addon" name="environment">
    ...
    $(document).ready(function () {
        $("#clients_sumt").submit(function (e) {
            ...
            $.ajax({
                ...
                beforeSend: function () {
              	  ajaxindicatorstart('⚙️ Processing Provider Onboarding... Please Wait.');
          	    },
                ...
                error: function (error) {
                    ...
                    //alert("Error during onboarding!");
                	 $("#onboard_msg").empty().append('Error during Provider Onboard.').css({
                         color: "green",
                         fontWeight: "bold",
                     });
                    $("#clients_sumt").trigger("reset");
