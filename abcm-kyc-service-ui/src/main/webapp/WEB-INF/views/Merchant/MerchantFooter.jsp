...
flatpickr(document.querySelector('#pc-date_range_picker-2'), {
    ...
    onReady: function() {
        // Show full range even if both dates are same
    ...
    // ✅ Initialize second date picker (same logic if needed)
    flatpickr(document.querySelector('#pc-date_range_picker-3'), {
        ...
        disable: [
            function (date) {
                return !(date.getDate() % 8); // disables all dates except divisible by 8
            }
        ],
        onReady: function() {
