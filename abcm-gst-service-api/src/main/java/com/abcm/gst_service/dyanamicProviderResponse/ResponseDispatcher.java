...
public class ResponseDispatcher {
    ...
    public <T> T getGstinResponse(String providerName, JSONObject input, String trackId, String merchanId, Long productRate,String orderId) {
       // System.out.println("ResponseDispatcher Enter: " + providerName);
        ...
        return handler.GstliteVerifyResponseToMerchant(input, trackId, merchanId, productRate,orderId);
    }
}
